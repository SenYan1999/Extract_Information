...
parser.add_argument('--do_preprocess', action='store_true', help='whether to do preprocess')
parser.add_argument('--do_train', action='store_true', help='whether to do train')
